...
from thulr.cli.composition import config_or_default, require_config_file
from thulr.connectors import route
...
def fetch(url: str) -> None:
    ...
    the seam `thulr.snapshot` materializes through. A pointed pull: this brings
    ...
    # `thulr.cli.run` turns those into the same message and the same
