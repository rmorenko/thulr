...
The seam the language plugins use (`thulr.ingest.plugins`), pointed at
...
from thulr.connectors import BUILTIN, SHIPPED, Connector, ConnectorFactory

ENTRY_POINT_GROUP = "thulr.connectors"
...
def load_connectors(
    ...
    *,
    ...
    connector — not at import time; see `thulr.connectors._ensure_plugins`
