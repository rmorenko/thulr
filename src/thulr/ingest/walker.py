...
class Skip(StrEnum):
    ...
    permissions. `thulr explain` turns these into that answer.
...
def detect_lang_kind(
    ...
    The table this used to hold is now `thulr.ingest.languages.REGISTRY`,
...
def examine(
    ...
    *,
    ...
    report a file it could not *read*, and `thulr explain` wants to
