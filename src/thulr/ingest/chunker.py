...
from thulr.ingest.ast import ast_chunks, gap_spans, mark_covered
from thulr.ingest.languages import REGISTRY, Section
from thulr.ingest.text_chunker import chunk_text
...
def chunk_file(text: str, source: SourceFile) -> list[Chunk]:
    ...
    grammar and the extractor together (see `thulr.ingest.languages`),
