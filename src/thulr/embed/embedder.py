...
class SentenceTransformerEmbedder(Embedder):
    ...
    def __init__(
        ...
        *,
        ...
        opens a store goes on to embed anything — `thulr compact` took
        ...
        Args:
            ...
            cache_folder: Where sentence-transformers keeps downloaded
                ...
                CLI passes a path under `$XDG_CACHE_HOME/thulr/` so the
            ...
            max_seq: Cap the model's input window, or None to accept
                ...
                chunks of a few hundred characters. Nothing thulr
