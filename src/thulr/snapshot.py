...
from thulr.connectors import ConnectorError, ConnectorSpec, Document, route
from thulr.ingest.git_state import GitCommandError, decode_path, run_git
...
_COMMIT_IDENTITY = ("-c", "user.name=thulr", "-c", "user.email=thulr@localhost")
