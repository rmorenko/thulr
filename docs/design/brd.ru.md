# BRD — Документ бизнес-требований: Thulr (Workspace Indexer)
...
| Поле             | Значение                                                                                |
| ---------------- | --------------------------------------------------------------------------------------- |
| Продукт          | Thulr (Workspace Indexer) — рабочее название                                            |
...
| Роль                                  | Кто это                             | Интерес / что важно                                                                                              | Как Thulr это закрывает                                                                       |
| ------------------------------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
...
| BG-P3 | Ценность для AI-агентов      | Thulr используется как источник контекста для агента/MCP                                        |
